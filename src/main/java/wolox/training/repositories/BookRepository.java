...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    public Page<Book> findByPublisherAndGenreAndYear(String publisher, String genre, String year, Pageable pageable);
    ...
    public Page<Book> findByPublisherAndGenreAndYearNameParams(@Param("publisher") String publisher,
    ...
    public Page<Book> findByFilters(@Param("genre") String genre, @Param("author") String author,
            @Param("image") String image, @Param("title") String title, @Param("subtitle") String subtitle,
            @Param("publisher") String publisher, @Param("year") String year, @Param("pages") Integer pages, Pageable pageable);
}
